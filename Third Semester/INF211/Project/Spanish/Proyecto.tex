...
\begin{center}
    \begin{Karnaugh}
        \contingut{1,1,\textbf{x},1,x,x,\textbf{x},x,x,x,\textbf{x},\textbf{x},1,1,\textbf{x},\textbf{x}}
    \implicant{0}{10}{green}
    \end{Karnaugh}
    %
   \begin{Karnaugh}
        \contingut{x,x,\textbf{x},x,1,1,\textbf{x},1,1,1,\textbf{x},\textbf{x},x,x,\textbf{x},\textbf{x}}
...
\begin{center}
    \begin{Karnaugh}
        \contingut{0,0,\textbf{x},0,1,1,\textbf{x},0,x,x,\textbf{x},\textbf{x},x,x,\textbf{x},\textbf{x}}
