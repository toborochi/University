...
\setcounter{n}{10}
\stepcounter{n}
\section*{a) Utilizando la interfaz \texttt{List}}
...
{%
  ...
  \subfile{TeXFiles/A/\enun\arabic{ct}}
  ...
  \lstinputlisting[language=Java,linebackgroundcolor={\ifodd\value{lstnumber}\color{claro}\fi}]{Code/A/\mystr\arabic{ct}.java}

  %\includegraphics[scale=0.75]{\mystr\arabic{ct}}
  %\mystr\arabic{ct}
}

\section*{b) Listas Parametrizadas}
...
{%
  \section*{\mystr\text{ }\arabic{ct}:}
  \subfile{TeXFiles/B/\enun\arabic{ct}}
  \IfFileExists{Images/\imag\arabic{ct}.png}{
  \begin{figure}[H]
  \centering
    \includegraphics[width={0.5\textwidth}]{\imag\arabic{ct}}
  ...
  \lstinputlisting[language=Java,linebackgroundcolor={\ifodd\value{lstnumber}\color{claro}\fi}]{Code/B/\mystr\arabic{ct}.java}
  %\includegraphics[scale=0.75]{\mystr\arabic{ct}}
  %\mystr\arabic{ct}
}

\section*{c) Iteradores}
Para los incisos \textbf{a)} y/o \textbf{b)} Utilizar Iteradores para recorrer la Lista. 
...
{%
  \section*{\mystr\text{ }\arabic{ct}:}
  \subfile{TeXFiles/C/\enun\arabic{ct}}
  \IfFileExists{Images/\imag\arabic{ct}.png}{
  \begin{figure}[H]
  \centering
    \includegraphics[width={0.5\textwidth}]{\imag\arabic{ct}}
  ...
  \lstinputlisting[language=Java,linebackgroundcolor={\ifodd\value{lstnumber}\color{claro}\fi}]{Code/C/\mystr\arabic{ct}.java}
  %\includegraphics[scale=0.75]{\mystr\arabic{ct}}
  %\mystr\arabic{ct}
}
