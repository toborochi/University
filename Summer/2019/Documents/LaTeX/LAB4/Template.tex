...
{%
  ...
  \IfFileExists{Images/\imag\arabic{ct}.jpeg}{
  \begin{figure}[H]
  \centering
    \includegraphics[width={0.5\textwidth}]{\imag\arabic{ct}}
  \end{figure}}{
  ...
  \lstinputlisting[breaklines=true,language=Java,linebackgroundcolor={\ifodd\value{lstnumber}\color{claro}\fi}]{Code/\mystr\arabic{ct}.java}
  \pagebreak
