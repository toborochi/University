...
\texttt{Python (Iterativo)}
\lstinputlisting[language=Python]{p7a.py}

\texttt{Python (Recursivo)}
\lstinputlisting[language=Python]{p7b.py}

\texttt{Prolog}
\lstinputlisting[language=Prolog]{p7c.pl}

8. \texttt{anteriorPrimo(n)} : Función que devuelve, el anterior primo antes de n. Si n es primo, devuelve n. \\

\texttt{Python (Iterativo)}
\lstinputlisting[language=Python]{p8a.py}

\texttt{Python (Recursivo)}
\lstinputlisting[language=Python]{p8b.py}

\texttt{Prolog}
\lstinputlisting[language=Prolog]{p8c.pl}

9. \texttt{mostrarPrimos(a, b)}: Procedimiento que muestra los número primos entre a y b, inclusive. \\

\texttt{Python (Iterativo)}
\lstinputlisting[language=Python]{p9a.py}

\texttt{Python (Recursivo)}
\lstinputlisting[language=Python]{p9b.py}

\texttt{Prolog}
\lstinputlisting[language=Prolog]{p9c.pl}

12. \texttt{mostrarFactoriales(n)}: Procedimiento que muestra los factoriales de 1 a n. \\

\texttt{Python (Iterativo)}
\lstinputlisting[language=Python]{p12a.py}

\texttt{Python (Recursivo)}
\lstinputlisting[language=Python]{p12b.py}

\texttt{Prolog}
\lstinputlisting[language=Prolog]{p12c.pl}

\pagebreak
13. \texttt{mostrarCoefBin(n)} : Procedimiento que muestra los coeficientes binomiales de un binomio elevado a la n. \\
...
\texttt{Prolog}
\lstinputlisting[language=Prolog]{p14c.pl}
