...
namespace T3tris.Classes
{
    public class Controller : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            camera.Target = new Vector3(((float)container.length) / 2.0f, ((float)container.depth) / 2.0f, ((float)container.height) / 2.0f);
        ...
        protected override void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            {
                if (container.encajaTraslacion(J.dibTetromino(J.Puntos), J.transform.Position))
                {
                    J.rotate();
                }
                xrot += 90; 
