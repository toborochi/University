...
\begin{center}
\begin{tikzpicture}
\pgfmathdeclarefunction{gausss}{2}{\pgfmathparse{1/(#2*sqrt(2*pi))*exp(-((x-#1)^2)/(2*#2^2))}%
}
\begin{axis}[
  ...
  \addplot [very thick,black!50!black,line width=0.3mm] {gausss(0,1)};



  
   
     \draw [very thick, dotted,line width=0.2mm]  (axis cs:0,0) -- (axis cs:0,0.4);
        
     \draw [very thick, dotted,line width=0.2mm]  (axis cs:-1.5,0) -- (axis cs:-1.5,0.13);
        
     \draw [very thick, dotted,line width=0.2mm]  (axis cs:1.5,0) -- (axis cs:1.5,0.13);
     
	     \draw [very thick, dotted,line width=0.2mm]  (axis cs:-4,0.13) -- (axis cs:1.5,0.13);     
     
     \draw [very thick, dotted,line width=0.2mm]  (axis cs:-4,0.4) -- (axis cs:0,0.4); 
     
  \node[below] at (axis cs:0,0)  {$\mu$}; 
  \node[below] at (axis cs:-1.5,0)  {$\mu-\sigma$}; 
  \node[below] at (axis cs:1.5,0)  {$\mu+\sigma$}; 
  
  \node[above] at (axis cs:0,0.45)  {$\dfrac{1}{\sigma\sqrt{2\pi}}$}; 
\end{axis}
...
\addplot [fill=red!20, draw=none, domain=-1.5:1.5] {gausss(0,1)} \closedcycle;
  \addplot [very thick,black!50!black,line width=0.3mm] {gausss(0,1)};
  ...
  \node[below] at (axis cs:1.5,0)  {$b$}; 
  
  \node[above] at (axis cs:0,0.45)  {$P(a\leq x \leq b)$}; 
\end{axis}
...
\begin{axis}[
  ...
  \addplot[very thick,black!50!black,line width=0.3mm]   (x,{sigma(x)});
  \draw [very thick, dotted,line width=0.2mm]  (axis cs:-4,1) -- (axis cs:4,1);
  \draw [very thick, dotted,line width=0.2mm]  (axis cs:-4,0.5) -- (axis cs:4,0.5);
    \node[below] at (axis cs:0,0)  {$0$}; 
    \node[left] at (axis cs:0,0.5)  {$0.5$}; 
    \node[above] at (axis cs:0,1)  {$1$}; 
\end{axis}
...
\addplot [fill=red!20, draw=none, domain=-1:1] {gausss(0,1)} \closedcycle;
  \addplot [very thick,black!50!black,line width=0.3mm] {gausss(0,1)};

        
     \draw [very thick, dotted,line width=0.2mm]  (axis cs:-1,0) -- (axis cs:-1,0.23);
...
\subsubsection{Manejo de la tabla}
\begin{enumerate}
...
\begin{axis}[
  ...
  axis lines*=left, xlabel=$t$, ylabel=${ }$,
  every axis y label/.style={at=(current axis.above origin),anchor=south},
  every axis x label/.style={at=(current axis.right of origin),anchor=west},
  height=5cm, width=12cm,
  xtick=\empty, ytick=\empty,
...
\subsubsection{Uso de la Tabla}
Si $T\sim t(r)$, entonces en la tabla de probabilidad de $t$-student, se puede encontrar una probabilidad $1-\alpha$ o un valor $c=t_{1-\alpha}(r)$, mediante la relación: 

$$P(T\leq c) = 1-\alpha \vee P(T\leq t_{1-\alpha}(r) = 1-\alpha $$
...
\begin{axis}[
  ...
  \addplot [fill=red!20, draw=none, domain=0:5.5] {gauss(4,1.5)} \closedcycle;
  \addplot [very thick,black!50!black,line width=0.3mm] {gauss(4,1.5)};


  \node[below] at (axis cs:5.5,0)  {$c=t_{1-\alpha}(r)$}; 
  
    \draw [very thick, dotted,line width=0.2mm]  (axis cs:5.5,0) -- (axis cs:5.5,0.16);
    
    \draw (4,0.12) node[] {$1-\alpha$};
\end{axis}
