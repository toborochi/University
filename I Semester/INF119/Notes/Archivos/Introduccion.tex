...
% Caratula 
\title{Apuntes de Estructuras Discretas}
...
Estos apuntes fueron realizados durante mis clases en la materia \texttt{INF119 (Estructuras Discretas)}, acompañados de referencias de libros, y fuentes que use a lo largo del curso, en el período \texttt{I-2017} en la Facultad de Ingeniería en Ciencias de la Computación y Telecomunicaciones. 
\\ \vspace{0.5cm} \\
