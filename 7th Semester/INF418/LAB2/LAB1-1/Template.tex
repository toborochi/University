...
%\pagebreak
\noindent
{\LARGE \textbf{Aplicaciones de Permutaciones y Combinaciones.}} \\
Revisar la web, libros, publicaciones y otros, buscar problemas propuestos sobre Combinaciones y Permutaciones con y sin repeticiones de elementos. Aplicar los algoritmos de \texttt{combinacionesSR()}, \texttt{combinacionesCR()},\\ \texttt{permutacionesSR()},\texttt{permutacionesCR()} o modificarlos para dar solución a los problemas propuestos en esas fuentes de información. Aplicar al menos 1 problemas cualesquiera para cada Algoritmo, por cada integrante de grupo. Citar Fuentes.\\{ }\\
{\LARGE \textbf{I.} Combinaciones sin Repeticiones}
\newcounter{ct}
\newcounter{n}
